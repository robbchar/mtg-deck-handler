...
import type { DeckMetadata } from '../types'
 ...
 *
 * Displays deck name (link to editor), format badge, card count, last-updated
 * date, and a delete button with inline two-step confirmation.
 */
