...
function ImportModal({ isOpen, onClose }) {
  ...
  const [preview, setPreview] = useState(/** @type {null | ReturnType<typeof parseMtgaText>} */ (null))
  ...
  async function handleImport() {
    ...
    try {
      ...
      setApiError(err?.response?.data?.error ?? err?.message ?? 'Import failed. Please try again.')
    } finally {
      setImporting(false)
    }
  }
