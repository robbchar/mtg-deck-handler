...
interface CardSearchProps {
  isOpen: boolean
  onClose: () => void
  onAddCard: (card: ScryfallCard, section: 'mainboard' | 'sideboard') => void
}
 ...
 */
function CardSearch({ isOpen, onClose, onAddCard }: CardSearchProps) {
  ...
  function handleSectionSelect(section: 'mainboard' | 'sideboard') {
